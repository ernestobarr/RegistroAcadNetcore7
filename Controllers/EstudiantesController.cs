...
namespace Web.Controllers
{
    ...
    public class EstudiantesController : Controller
    {
        ...
        public EstudiantesController(BC100520Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Estudiantes != null ? 
                          ...
                          Problem("Entity set 'BC100520Context.Estudiantes'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("IdEstudiante,Nombre,CorreoElectronico,FechaNac")] Estudiante estudiante)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdEstudiante,Nombre,CorreoElectronico,FechaNac")] Estudiante estudiante)
        {
